...
async function runMigration() {
    ...
    `, ['60db0ccd-b7c9-4377-a386-33ace2bae63f']);
      ...
      `, [(0, crypto_1.randomUUID)(), '60db0ccd-b7c9-4377-a386-33ace2bae63f']);
        }
        // Step 4: Verify migration
        const verifyResult = await client.query('SELECT * FROM admins WHERE user_id = $1', ['60db0ccd-b7c9-4377-a386-33ace2bae63f']);
