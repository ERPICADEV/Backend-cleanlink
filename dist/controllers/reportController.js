...
exports.getPreSubmissionSuggestions = exports.updateReport = exports.getReport = exports.createReport = exports.getReports = void 0;
...
const getPreSubmissionSuggestions = async (req, res) => {
    try {
        ...
        const service = new preSubmissionService_1.PreSubmissionService(apiKey);
...
exports.getPreSubmissionSuggestions = getPreSubmissionSuggestions;
